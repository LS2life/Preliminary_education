...
var t = (t2, b2 = {}) => {
  ...
  return Promise.resolve().then(() => P = setTimeout(() => C && (t2.innerHTML = ""), W)), { update(r2) {
    ...
    w(r2);
    const o2 = (_a = r2.particleCount) != null ? _a : G, a2 = (_b = r2.colors) != null ? _b : k2, i2 = (_c = r2.stageHeight) != null ? _c : z;
    ...
    o2 !== G && (t2.innerHTML = "", H = e(t2, A)), C && !r2.destroyAfterDone && clearTimeout(P), t2.style.setProperty("--stage-height", i2 + "px"), k2 = a2, W = (_d = r2.duration) != null ? _d : W, S = (_e = r2.force) != null ? _e : S, G = o2, X = (_f = r2.particleShape) != null ? _f : X, _ = (_g = r2.particleSize) != null ? _g : _, C = (_h = r2.destroyAfterDone) != null ? _h : C, z = i2, E = (_i = r2.stageWidth) != null ? _i : E;
  }, destroy() {
    clearTimeout(P);
  } };
};
